/*!
 * 扩展 less-middleware 模块
 * 功能：在编译好的css文件所在目录生成一个“同名”的map文件，并在css文件末尾追加 “sourceMap”
 * 扩展原因：less-middleware(0.1.14) 默认所支持 “sourceMap” 在chrome(31.0.1650.63)下不能定位less文件及行号
 * 使用方法：
 <code>
 app.use(require('./path/to/less-middleware-with-sourcemap')({
 src: "/less",
 dest: "/css",
 root: path.join(__dirname, 'views/static/stylesheets'),
 sourceMap: true,
